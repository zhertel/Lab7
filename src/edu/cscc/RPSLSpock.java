...
public class RPSLSpock {
    ...
    /**
     * Verify that the user's choice is a valid action in the game.
     * @param pick The user's input for their action.
     * @return A boolean that is True if the user's action, ignoring case, is "rock", "paper", "scissors", "lizard", or "spock".
     */
    ...
    /**
     * Randomly select the computer's action in the game.
     * @return One of the following String values: "rock", "paper", "scissors", "lizard", or "spock".
     */
    ...
    /**
     * Check whether the computer's action beats the user's action in the game.
     * @param c_pick The computer's choice of action in the game.
     * @param h_pick The user's choice of action in the game.
     * @return A boolean that is True if the user's action is one of the 2 actions that loses to the computer's action.
     */
